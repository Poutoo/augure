...
def insert_to_db(connection, title, slug, total_views, platform_name, category, hashtags, music, description=None, context=None, age_dist=None, original_post_at=None, dry_run=False):
    ...
    connection.execute(query, {
        ...
        "title": title, 
        "slug": slug,
        "description": description or "La description de cette tendance n'est pas encore disponible. Nous vous prions de nous excuser pour ce désagrément et vous invitons à réessayer ultérieurement.",
        "context": context or "Le contexte de cette tendance n'est pas encore disponible. Nous vous prions de nous excuser pour ce désagrément et vous invitons à réessayer ultérieurement.",
        "usage_example": "L'exemple d'usage pour cette tendance n'est pas encore disponible. Nous vous prions de nous excuser pour ce désagrément et vous invitons à réessayer ultérieurement.",
        "score": total_views, 
